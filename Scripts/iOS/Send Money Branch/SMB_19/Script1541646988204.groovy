...
TestObject Receiver_Current_Address = findTestObject('iOS/Global/Generic text', [('label') : '086 Bgy Loob, 3117, Vietnam'])
TestObject Destination_Country = findTestObject('iOS/Global/Generic text', [('label') : 'Vietnam'])

CustomKeywords.'iOS.send_money_screen.tapCurrentAddress'()

TestObject Country_field = findTestObject('iOS/Global/Generic field', [('value') : 'Cambodia'])

CustomKeywords.'iOS.send_money_screen.selectDropdown'(Country_field, 'Vietnam')

TestObject Postal_field = findTestObject('iOS/Global/Generic field', [('value') : '1442'])

CustomKeywords.'iOS.send_money_screen.enterField'(Postal_field, '3117')

TestObject UnitHouse_NumberBuildingStreet_field = findTestObject('iOS/Global/Generic field', [('value') : '503 Tindalo'])

CustomKeywords.'iOS.send_money_screen.enterField'(UnitHouse_NumberBuildingStreet_field, '086 Bgy Loob')

TestObject Destination_Country_field = findTestObject('iOS/Global/Generic field', [('value') : 'Cambodia'])
